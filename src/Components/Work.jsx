...
const Work = () => {
  ...
  return (
    <div className=" font-mono bg-slate-100 text-[#d8874a]">
      <h1 className=" my-3 text-center text-3xl font-bold">My Experties</h1>
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical mx-8">
        {data.map((exp)=>(
